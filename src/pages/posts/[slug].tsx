...
interface SingleServiceProps {
  procedure: {
    ...
    title: string
    content: string
    galery?: ProcedureGaleryData[]
    faq: ProcedureFaqData[]
  }
}
        ...
        <main className="w-4/5 lg:w-2/3 m-auto bg-white-100 z-50 rounded-sm lg:flex lg:justify-center shadow-lg ">
          <div className="md:flex ">
            ...
            <div className="w-full p-5 pb-10 md:p-10 flex flex-col justify-center bg-white-300 ">
              <h1 className="py-4 md:m-0 text-center md:text-start text-2xl lg:text-4xl text-gray-300 font-merriweather ">
                {procedure.title}
              </h1>
