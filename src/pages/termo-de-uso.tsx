      ...
      <div className="w-full ">
        ...
        <section className="w-full max-w-[1024px] m-auto py-14 px-5 ">
          ...
          <p className={`${paragraph}`}>
            ...
            autorizado da Clínica Relance tenha sido notificado oralmente ou por
          ...
          <h3>6. Links</h3>
          <p className={`${paragraph}`}>
            A Clínica Relance não analisou todos os sites vinculados ao seu site
            e não é responsável pelo conteúdo de nenhum site vinculado. A
            inclusão de qualquer link não implica endosso por Clínica Relance do
          ...
          <p className={`${paragraph}`}>
            ...
            as leis da Clínica Relance e você se submete irrevogavelmente à
