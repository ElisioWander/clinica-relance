  ...
  return (
    <header className="w-10/12 max-w[1080px] h-20 m-auto flex items-center justify-between ">
      ...
      <nav className="hidden md:block md:h-20 " >
        <Link href="/" >
          <a className={`h-20 inline-block leading-[80px] ml-7 relative hover:brightness-0 text-gray-300 text-sm lg:text-[16px] font-poppins transition-all
            ${asPath == "/"
